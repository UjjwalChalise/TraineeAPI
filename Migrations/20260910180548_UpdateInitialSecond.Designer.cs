...
namespace TraineeAPI.Migrations
{
    ...
    [Migration("20260910180548_UpdateInitialSecond")]
    partial class UpdateInitialSecond
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraineeAPI.Models.Module", b =>
                {
                    b.HasOne("TraineeAPI.Models.Teacher", "PrimaryTeacher")
                        .WithMany("PrimaryModules")
            ...
            modelBuilder.Entity("TraineeAPI.Models.UserDetails", b =>
                {
                    b.HasOne("TraineeAPI.Models.User", "User")
                        .WithOne("UserDetails")
                        .HasForeignKey("TraineeAPI.Models.UserDetails", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
